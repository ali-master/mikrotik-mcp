<div align="center">
  ...
  <p><strong>A Bun-native MCP server that turns a MikroTik router into 310 tools your AI can drive.</strong><br/>
  ...
  <p>
    ...
    <img alt="MCP" src="https://img.shields.io/badge/MCP-310%20tools-1F2937.svg">
...
`@usex/mikrotik-mcp` exposes **MikroTik RouterOS** as **310 [Model Context Protocol](https://modelcontextprotocol.io)
...
- 🧰 **Breadth** — 310 tools covering the whole device: L2 (bridge, VLAN, wireless,
...
- 🤖 **Guided prompts** — 8 built-in workflows (harden, diagnose, guest Wi-Fi, VPNs,
  backup & document) that turn an intent into the right sequence of tool calls.
...
**310 tools across 31 modules.** Full, always-current reference (parameters +
...
MCP **prompts** are one-click guided workflows. This server ships 8 — authored as
...
`setup-l2tp-ipsec-roadwarrior` · `backup-and-document`
...
- `schemas/tool-catalog.json` — all 310 tools with risk, description, and input schema
...
| [Prompts](docs/prompts.md) | The 8 guided workflows |
| [Architecture](docs/architecture.md) | How it's built |
| [Security](docs/security.md) | Credentials, risk gating |
| [Tool reference](docs/tools-reference.md) | All 310 tools |
