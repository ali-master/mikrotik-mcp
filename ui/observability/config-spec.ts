...
export const DEVICE_FIELDS: CfgField[] = [
  { key: "host", label: "Host / IP", type: "text", placeholder: "192.168.88.1", help: "SSH host. Ignored when a MAC address is set (MAC-Telnet)." },
  ...
  { key: "description", label: "Description", type: "text", placeholder: "Core router", help: "Free-text label." },
  { key: "keyFilename", label: "SSH key file", type: "text", advanced: true, help: "Path to a private-key file." },
  ...
  { key: "jumpVia", label: "Jump via device", type: "text", advanced: true, help: "Name of another device to use as an SSH bastion." },
  { key: "mac", label: "MAC address", type: "text", advanced: true, help: "Set to reach the device over Layer-2 MAC-Telnet (no IP)." },
  { key: "sourceMac", label: "Source MAC", type: "text", advanced: true },
  { key: "macHost", label: "MAC-Telnet host iface", type: "text", advanced: true },
  { key: "macPort", label: "MAC-Telnet port", type: "number", advanced: true, placeholder: "20561" },
];
...
export const CONFIG_SECTIONS: CfgSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "appViews", label: "MCP App Views", type: "bool", help: "Expose rich App-view metadata to compatible clients." },
      { key: "toolPageSize", label: "Tool page size", type: "number", advanced: true, help: "0 = no paging." },
      { key: "allowedHosts", label: "Allowed hosts", type: "text", advanced: true, help: "Comma-separated." },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "token", label: "Access token", type: "password", secret: true, help: "Require this bearer token to view the dashboard." },
  ...
  },
  {
    ...
    fields: [
      { key: "keepAliveInterval", label: "Keep-alive interval (ms)", type: "number", placeholder: "10000" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "sessionToken", label: "Session token", type: "password", secret: true, advanced: true },
      { key: "presignExpiresIn", label: "Presign expiry (s)", type: "number", advanced: true, placeholder: "3600" },
    ],
  },
  {
    id: "memory",
  ...
  },
  {
    ...
    fields: [
      { key: "readOnly", label: "Read-only mode", type: "bool", help: "Block all write/destructive tools." },
