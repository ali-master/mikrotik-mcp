...
export const moduleCatalog: ModuleInfo[] = [
  // ── Layer 2 / interfaces ─────────────────────────────────────────────────
  { label: "Interfaces", slug: "interfaces", group: "Interfaces", description: "Generic interface listing and enable/disable (`/interface`).", tools: interfaceTools },
  { label: "VLAN", slug: "vlan", group: "Interfaces", description: "802.1Q VLAN interfaces (`/interface vlan`).", tools: vlanTools },
  { label: "Bridge", slug: "bridge", group: "Interfaces", description: "Bridges, ports, host table and bridge VLANs (`/interface bridge`).", tools: bridgeTools },
  { label: "Wireless", slug: "wireless", group: "Interfaces", description: "Wireless interfaces, security profiles and access lists (legacy + wifiwave2).", tools: wirelessTools },
  { label: "PoE", slug: "poe", group: "Interfaces", description: "Power-over-Ethernet status and configuration (`/interface ethernet poe`).", tools: poeTools },
  ...
  { label: "Address Lists", slug: "address-list", group: "Security", description: "Firewall address-lists (`/ip firewall address-list`).", tools: addressListTools },
  { label: "Certificates", slug: "certificate", group: "Security", description: "X.509 certificate management (`/certificate`).", tools: certificateTools },
  { label: "IP Services", slug: "ip-service", group: "Security", description: "Management service ports — ssh/www/api/telnet (`/ip service`).", tools: ipServiceTools },
  // ── VPN / tunneling ──────────────────────────────────────────────────────
  { label: "WireGuard", slug: "wireguard", group: "VPN & Tunneling", description: "WireGuard interfaces, peers and client-config generation.", tools: wireguardTools },
  { label: "IPsec", slug: "ipsec", group: "VPN & Tunneling", description: "IPsec IKEv1/IKEv2: profiles, peers, identities, proposals, policies, SAs (`/ip ipsec`).", tools: ipsecTools },
  { label: "PPP", slug: "ppp", group: "VPN & Tunneling", description: "Shared PPP backend: profiles, secrets, active sessions (`/ppp`).", tools: pppTools },
  { label: "L2TP", slug: "l2tp", group: "VPN & Tunneling", description: "L2TP server + clients, incl. L2TP/IPsec (`/interface l2tp-*`).", tools: l2tpTools },
  { label: "PPTP", slug: "pptp", group: "VPN & Tunneling", description: "PPTP server + clients (legacy) (`/interface pptp-*`).", tools: pptpTools },
